...
def run_custom_GBD_model(polyploid, simulation_leg, base_gene_tree_newicks_by_tree_name):
    ...
    for gt_idx in range(0, num_gene_trees_needed):
        ...
        if skip_GBD_model:
            ...
            gene_tree_newick_with_GBD, randomness_idx = add_GBD_to_newick(base_gene_tree_newick,
                                                      gene_tree_name,
    ...
    log.write_to_log("pruned_tree_files:\t" + str(new_gene_trees))
...
def add_GBD_to_newick(base_gene_tree_newick, gene_tree_name,
        ...
        log.write_to_log("adding the new genes.. ")
        ...
        return gene_tree_newick_with_GBD, randomness_idx
