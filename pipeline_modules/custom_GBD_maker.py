...
def run_custom_GBD_model(polyploid, simulation_leg, base_gene_tree_newicks_by_tree_name):
    ...
    dup_values, loss_values = sagephy_GBD_model.get_randomized_dup_and_loss_rates(
        dup_rate_parameters, loss_rate_parameters, num_gene_trees_needed)

    if include_visualizations:
        sagephy_GBD_model.visualize_dup_and_loss_rates(dup_values, loss_values, subfolder)
