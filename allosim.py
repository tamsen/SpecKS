...
def run_allosim(polyploid):
    ...
    #TODO - gene shedding currently throws off evolver bc the gene tree topology includes shedding,
    # probably can be fixed by updating
    # gene_tree_result.info_dict["No. of vertices"]
    # and gene_tree_result.info_dict["No. of extant leaves"]
