...
class HistogramerTests(unittest.TestCase):
    def test_get_Ks_from_GeneTree0_file(self):
        ...
        for ks_result in ks_results:
            print("ks_value is\t" + str(ks_result.ks_between_orthologs)
        ...
        self.assertEqual(ks_results[0].ks_between_orthologs, 4.7313)
    ...
    def test_get_Ks_from_GeneTree4_file(self):
        ...
        self.assertEqual(ks_results[0].ks_between_orthologs, 3.3035)
        self.assertEqual(ks_results[5].ortholog_pair, ['G5_2', 'G3_2'])
        self.assertEqual(ks_results[5].ks_between_orthologs, 2.9798)
